...
Une application de suivi et de gestion de candidatures professionnelles.

## 📋 Description

Propulse est une plateforme complète conçue pour simplifier et optimiser la gestion de vos candidatures professionnelles. L'application offre une interface avec plusieurs vues et fonctionnalités pour suivre vos opportunités de carrière.
